...
<table class="table">
         ...
         <tr  class="info">
             <td style="width: 84%;"><strong>Coût total d'achat du cheptel (15 ans)</strong></td>
...
<table class="table">
         <tr>
             <td style="width: 84%;"><strong>Coût total des aménagements dont l'hébergement hors bâtiments (7 ans)</strong></td>
             <td style="text-align: right;"><strong><?php echo number_format(ahb($list,$listF),2,',','.'); ?> €</strong></td>
         </tr>
</table>
...
<table class="table">
         <tr>
             <td style="width: 84%;">Coût annuel des coûts d'installation (pendant 7 ans)</td>
             <td style="text-align: right;"><?php echo number_format(caciav7($list,$listF),2,',','.'); ?> €</td>
         </tr>
         <tr>
             <td style="width: 84%;">Coût annuel des coûts d'installation (pendant 15 ans)</td>
             <td style="text-align: right;"><?php echo number_format(caci15($list,$listF),2,',','.'); ?> €</td>
         </tr>
</table>
...
<table class="table">
         <tr>
             <td style="width: 84%;">Coût annuel de cheptel</td>
             <td style="text-align: right;"><?php echo number_format(rac($list,$listF),2,',','.'); ?> €</td>
         </tr>
</table>
...
<table class="table">
         ...
         <tr  class="info">
             ...
             <td style="text-align: right;"><strong><?php echo number_format(ali($list,$listF),2,',','.'); ?> €</strong></td>
         </tr>
</table>
...
<table class="table">
         ...
         <tr class="info">
             <td style="width: 84%;"><strong>Frais de fonctionnement</strong></td>
             <td style="text-align: right;"><strong><?php echo number_format(fft($list,$listF),2,',','.'); ?> €</strong></td>
         </tr>
</table>
...
<table class="table">
         <tr>
             <td style="width: 84%;">Vente de porcs d'engraissement</td>
             <td style="text-align: right;"><?php echo number_format(vpg($list,$listF),2,',','.'); ?> €</td>
         </tr>
         <tr>
             <td style="width: 84%;">Vente de porcelets</td>
             <td style="text-align: right;"><?php echo number_format(vp($list),2,',','.'); ?> €</td>
         </tr>
</table>
...
<table class="table">
        <tr <?php if(rt1($list,$listF) == 0) echo 'class=info'; else if(rt1($list,$listF) > 0) echo 'class=success'; else echo 'class=error'; ?>>
             ...
             <td style="text-align: right;"><strong><?php echo number_format(rt1($list,$listF),2,',','.'); ?> €</strong></td>
         </tr>
         <tr <?php if(rt($list,$listF) == 0) echo 'class=info'; else if(rt($list,$listF) > 0) echo 'class=success'; else echo 'class=error'; ?>>
             <td style="width: 84%;"><strong>Années > 1 </strong></td>
             <td style="text-align: right;"><strong><?php echo number_format(rt($list,$listF),2,',','.'); ?> €</strong></td>
         </tr>
</table>
...
<table class="table">
        <tr <?php if(ch1($list,$listF) == 0) echo 'class=info'; else if(ch1($list,$listF) > 0) echo 'class=success'; else echo 'class=error'; ?>>
             <td style="width: 84%;"><strong>Année 1</strong></td>
             <td style="text-align: right;"><strong><?php echo number_format(ch1($list,$listF),2,',','.'); ?> €</strong></td>
         </tr>
         <tr <?php if(chav7($list,$listF) == 0) echo 'class=info'; else if(chav7($list,$listF) > 0) echo 'class=success'; else echo 'class=error'; ?>>
             ...
             <td style="text-align: right;"><strong><?php echo number_format(chav7($list,$listF),2,',','.'); ?> €</strong></td>
         </tr>
         <tr <?php if(chap7($list,$listF) == 0) echo 'class=info'; else if(chap7($list,$listF) > 0) echo 'class=success'; else echo 'class=error'; ?>>
             ...
             <td style="text-align: right;"><strong><?php echo number_format(chap7($list,$listF),2,',','.'); ?> €</strong></td>
         </tr>
         <tr <?php if(chap15($list,$listF) == 0) echo 'class=info'; else if(chap15($list,$listF) > 0) echo 'class=success'; else echo 'class=error'; ?>>
             ...
             <td style="text-align: right;"><strong><?php echo number_format(chap15($list,$listF),2,',','.'); ?> €</strong></td>
         </tr>
</table>
