<p>
    Les calculs sont réalisés sur base de choix opérés par l'utilisateur 
    et de variables encodées par défaut qui sont ou ne sont pas modifiables. 
    Elles le sont en cliquant dans les cases où elles apparaissent.<br/><br />
    L'utilisateur sélectionne des options via des listes déroulantes ou des boutons à cocher.
    Le prix des aliments est issu d'une moyenne des 3 dernières années et est modifiable.<br /><br />

    Toutes les valeurs sont considérées <strong>hors TVA</strong>.
</p>
<br />
